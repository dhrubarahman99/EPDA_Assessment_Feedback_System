...
<%
    ...
    if (modules == null || studentCounts == null) {
        response.sendRedirect(request.getContextPath() + "/lecturer_Reports");
        return;
    }
...
<div class="dashboard-container">
    ...
    <!-- TOP BAR -->
    <div class="top-bar">
        <a href="<%= request.getContextPath() %>/lecturer/dashboard.jsp" class="btn btn-secondary back-btn">Back</a>
